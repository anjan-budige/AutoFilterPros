...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.append(
            [InlineKeyboardButton("👉 How To Download 👈 ", url=f"hhttps://t.me/m4u_links")])
        btn.append(
        ...
        btn.append(
            [InlineKeyboardButton("👉 How To Download 👈 ", url=f"https://t.me/m4u_links")])
        ...
        btn.append([InlineKeyboardButton("👉 How To Download 👈 ", url=f"https://t.me/m4u_links")])
        btn.append([InlineKeyboardButton('Ok Close it 🙂', callback_data='close_data')])
    try:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase If You Want This Movie Join Our Channel https://t.me/m4u_links')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Channel 👀', url='https://t.me/m4u_links'),
            InlineKeyboardButton('Group 👀', url='https://t.me/m4u_links')
        ], [
            InlineKeyboardButton('Help ⚡', callback_data='help'),
            InlineKeyboardButton('About Me 💥', callback_data='about')
        ], [
            InlineKeyboardButton('Any Queries DM Here ✅',url='https://t.me/ml_contact_bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('Developer 😎', url='https://t.me/ml_contact_bot'),
            InlineKeyboardButton('Source Code', url='https:/github.com/anjan-budige/AutoFilterPros')
        ], [
            InlineKeyboardButton('🏠 Home', callback_data='start'),
            InlineKeyboardButton('Ok Close it', callback_data='close_data')
        ]]
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I couldn't find any movie in that name. If You Want Tis Movi e Request Us at - https://t.me/ml_contact_bot")
