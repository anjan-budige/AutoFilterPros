    ...
    if imdb and imdb.get('poster'):
        try:
          ...
          await a.delete()
            ...
            await message.reply_photo(photo="https://te.legra.ph/file/f8a066f176362079d4433.jpg", caption=cap[:1024], reply_markup=InlineKeyboardMarkup(btn))
        except Exception as e:
            logger.exception(e)
            await message.reply_text(photo="https://te.legra.ph/file/f8a066f176362079d4433.jpg", cap, reply_markup=InlineKeyboardMarkup(btn))
    else:
